    ...
    switch (property) {
      ...
      case 'errorCode':
        switch (properties[property]) {
          ...
          case 38:
            report.errorCode = { value: 38, description: 'water tank full or missing' }
            break
      ...
      case 'dehumidifierMode':
        switch (properties[property]) {
          case 1:
            report.dehumidifierMode = { value: 1, description: 'set point' }
            break
          case 2:
            report.dehumidifierMode = { value: 2, description: 'continuous operation' }
            break
          case 3:
            report.dehumidifierMode = { value: 3, description: 'smart' }
            break
          case 4:
            report.dehumidifierMode = { value: 4, description: 'clothes drying' }
            break
        }
        break
